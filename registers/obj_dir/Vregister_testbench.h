...
VL_MODULE(Vregister_testbench) {
  public:
    ...
    CData/*0:0*/ register_testbench__DOT__ctl_regB_assert_main;
    ...
    // LOCAL VARIABLES
    // Internals; generally not touched by application code
    CData/*7:0*/ register_testbench__DOT__b_8bit_main__out__out10;
  ...
  public:
    ...
    static void _combo__TOP__7(Vregister_testbench__Syms* __restrict vlSymsp);
  private:
  ...
  public:
    ...
    static void _multiclk__TOP__6(Vregister_testbench__Syms* __restrict vlSymsp);
